...
object Constants {
    ...
    const val KEY_LIMIT_AMOUNT = "limitAmount"
    const val KEY_TAX_AMOUNT = "taxAmount"
    const val KEY_PRINT_HEADER = "printHeader"
    const val KEY_PRINT_FOOTER = "printFooter"
    const val SERVER_CHANNEL_ID = "0x001"
