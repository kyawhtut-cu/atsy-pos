...
public class TablePagination implements IPagination {
     ...
     */
    public TablePagination(@NonNull ITableView tableView) {
     ...
     */
    public TablePagination(@NonNull ITableView tableView, int itemsPerPage) {
     ...
     */
    public TablePagination(@NonNull ITableView tableView, int itemsPerPage, @Nullable Pagination.OnTableViewPageTurnedListener listener) {
        initialize(tableView, itemsPerPage, listener);
    }

    private void initialize(@NonNull ITableView tableView, int itemsPerPage, @Nullable Pagination.OnTableViewPageTurnedListener listener) {
    ...
    @Override
    public void setOnTableViewPageTurnedListener(Pagination.OnTableViewPageTurnedListener onTableViewPageTurnedListener) {
